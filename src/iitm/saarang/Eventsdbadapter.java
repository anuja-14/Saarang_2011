...
public class  Eventsdbadapter{
    ...
    private static final String DATABASE_CREATE =
            "create table events (_id integer primary key autoincrement, "
                    + "name text  not null, type text not null,description text not null);";
     ...
     */
    public long createNote(String name,String type,String description) {
     ...
     */
    public boolean updateNote(long rowId, String name, String type,String description) {
